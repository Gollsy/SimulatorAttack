...
def get_exp_dir_name(dataset, loss, norm, targeted, target_type, surrogate_model_names, args):
    ...
    if args.attack_defense:
        dirname = 'SWITCH_rnd_save_stats_attack_using_{}_defensive_model-{}-{}_loss-{}-{}'.format(",".join(surrogate_model_names),
                                                                                             dataset, loss, norm, target_str)
    else:
        dirname = 'SWITCH_rnd_save_stats_attack_using_{}-{}-{}_loss-{}-{}'.format(",".join(surrogate_model_names),
                                                                             dataset, loss, norm, target_str)
    return dirname
